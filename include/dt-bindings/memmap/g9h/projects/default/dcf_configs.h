...
const dcf_configs_t dcf_configs_list = {
	...
	.dcf_config[2].paddr = 0x31E00000,
	.dcf_config[2].size = 0x200000,
	.dcf_config[2].mid_src = 0,
	.dcf_config[2].mid_dst = 4,
	.dcf_config[2].mid_master = 4,
	.dcf_config[2].channel = 2,
	.dcf_config[3].res_id = RES_DDR_DDR_MEM_SAF_MP,
	.dcf_config[3].paddr = 0x32000000,
	.dcf_config[3].size = 0x200000,
	.dcf_config[3].mid_src = 0,
	.dcf_config[3].mid_dst = 2,
	.dcf_config[3].mid_master = 2,
	.dcf_config[3].channel = 3,
	.dcf_config[4].res_id = RES_DDR_DDR_MEM_SEC_AP1,
	.dcf_config[4].paddr = 0x32200000,
	.dcf_config[4].size = 0x200000,
	.dcf_config[4].mid_src = 1,
	.dcf_config[4].mid_dst = 3,
	.dcf_config[4].mid_master = 3,
	.dcf_config[4].channel = 4,
	.dcf_config[5].res_id = RES_DDR_DDR_MEM_SEC_AP2,
	.dcf_config[5].paddr = 0x32400000,
	.dcf_config[5].size = 0x200000,
	.dcf_config[5].mid_src = 1,
	.dcf_config[5].mid_dst = 4,
	.dcf_config[5].mid_master = 4,
	.dcf_config[5].channel = 5,
	.dcf_config[6].res_id = RES_DDR_DDR_MEM_SEC_MP,
	.dcf_config[6].paddr = 0x32600000,
	.dcf_config[6].size = 0x200000,
	.dcf_config[6].mid_src = 1,
	.dcf_config[6].mid_dst = 2,
	.dcf_config[6].mid_master = 2,
	.dcf_config[6].channel = 6,
	.dcf_config[7].res_id = RES_DDR_DDR_MEM_MP_AP1,
	.dcf_config[7].paddr = 0x32800000,
	.dcf_config[7].size = 0x200000,
	.dcf_config[7].mid_src = 2,
	.dcf_config[7].mid_dst = 3,
	.dcf_config[7].mid_master = 3,
	.dcf_config[7].channel = 7,
	.dcf_config[8].res_id = RES_DDR_DDR_MEM_MP_AP2,
	.dcf_config[8].paddr = 0x32A00000,
	.dcf_config[8].size = 0x200000,
	.dcf_config[8].mid_src = 2,
	.dcf_config[8].mid_dst = 4,
	.dcf_config[8].mid_master = 4,
	.dcf_config[8].channel = 8,
	.dcf_config[9].res_id = RES_DDR_DDR_MEM_AP1_AP2,
	.dcf_config[9].paddr = 0x32C00000,
	.dcf_config[9].size = 0x200000,
	.dcf_config[9].mid_src = 3,
	.dcf_config[9].mid_dst = 4,
	.dcf_config[9].mid_master = 3,
