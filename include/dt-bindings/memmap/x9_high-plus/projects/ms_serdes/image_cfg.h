...
#define AP1_HYP_MEMBASE 0x4F800000
#define AP1_HYP_MEMSIZE 0x2000000
#define AP1_DOM0_MEMBASE 0x51800000
#define AP1_DOM0_MEMSIZE 0x2000000
#define AP1_REE_MEMBASE 0x4F800000
#define AP1_REE_MEMSIZE 0x60000000
#define AP1_PRELOADER_MEMBASE 0x4FA00000
#define AP1_PRELOADER_MEMSIZE 0x400000
#define AP1_BOOTLOADER_MEMBASE 0x51800000
#define AP1_BOOTLOADER_MEMSIZE 0x800000
#define AP1_KERNEL_MEMBASE 0x53880000
#define AP1_KERNEL_MEMSIZE 0x5FE00000
#define AP1_BOARD_RAMDISK_MEMBASE 0x5B800000
#define AP1_BOARD_RAMDISK_MEMSIZE 0x10000000
#define SERVICES_MEMBASE 0xAF800000
#define SERVICES_MEMSIZE 0x5400000
#define AP2_IMAGES_MEMBASE 0xB4C00000
#define AP2_IMAGES_MEMSIZE 0x13000000
#define AP2_ATF_MEMBASE 0xC7C00000
#define AP2_ATF_MEMSIZE 0x200000
#define AP2_TEE_MEMBASE 0xC7E00000
#define AP2_TEE_MEMSIZE 0x1000000
#define AP2_REE_MEMBASE 0xC8E00000
#define AP2_REE_MEMSIZE 0x40000000
#define AP2_PRELOADER_MEMBASE 0xC9000000
#define AP2_PRELOADER_MEMSIZE 0x400000
#define AP2_BOOTLOADER_MEMBASE 0xCAE00000
#define AP2_BOOTLOADER_MEMSIZE 0x800000
#define AP2_KERNEL_MEMBASE 0xCCE80000
#define AP2_KERNEL_MEMSIZE 0x3FE00000
#define AP2_BOARD_RAMDISK_MEMBASE 0xD4E00000
#define AP2_BOARD_RAMDISK_MEMSIZE 0x10000000
#define AP2_BOARD_RAMDISK_EXT_MEMBASE 0xE4E00000
#define AP2_BOARD_RAMDISK_EXT_MEMSIZE 0x10000000
#define AP1_2ND_MEMBASE 0x108E00000
#define AP1_2ND_MEMSIZE 0x137200000
