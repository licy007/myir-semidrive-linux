...
#define SAF_AP2_MEMBASE 0x35C00000
#define SAF_AP2_MEMSIZE 0x200000
#define SEC_AP2_MEMBASE 0x35E00000
#define SEC_AP2_MEMSIZE 0x200000
#define AP2_ATF_MEMBASE 0x46000000
#define AP2_ATF_MEMSIZE 0x200000
#define AP2_TEE_MEMBASE 0x46200000
#define AP2_TEE_MEMSIZE 0x1000000
#define SAF_MEMBASE 0x37200000
#define SAF_MEMSIZE 0x10000000
#define AP2_HYP_MEMBASE 0x57200000
#define AP2_HYP_MEMSIZE 0x2000000
#define AP2_DOM0_MEMBASE 0x59200000
#define AP2_DOM0_MEMSIZE 0x2000000
#define AP2_REE_MEMBASE 0x57200000
#define AP2_REE_MEMSIZE 0x20000000
#define AP2_PRELOADER_MEMBASE 0x59200000
#define AP2_PRELOADER_MEMSIZE 0x400000
#define AP2_BOOTLOADER_MEMBASE 0x59800000
#define AP2_BOOTLOADER_MEMSIZE 0x800000
#define AP2_KERNEL_MEMBASE 0x5B280000
#define AP2_KERNEL_MEMSIZE 0x1FE00000
#define AP2_BOARD_RAMDISK_MEMBASE 0x63200000
#define AP2_BOARD_RAMDISK_MEMSIZE 0x2000000
#define SERVICES_MEMBASE 0x77200000
#define SERVICES_MEMSIZE 0x5400000
#define AP2_2ND_MEMBASE 0x7C600000
#define AP2_2ND_MEMSIZE 0x43A00000
