...
void register_irq_proc(unsigned int irq, struct irq_desc *desc)
{
	...
	proc_create_data("smp_affinity", 0666, desc->dir,
			 &irq_affinity_proc_fops, irqp);

	/* create /proc/irq/<irq>/affinity_hint */
	proc_create_data("affinity_hint", 0666, desc->dir,
			 &irq_affinity_hint_proc_fops, irqp);

	/* create /proc/irq/<irq>/smp_affinity_list */
	proc_create_data("smp_affinity_list", 0666, desc->dir,
			 &irq_affinity_list_proc_fops, irqp);

	proc_create_data("node", 0444, desc->dir,
			 &irq_node_proc_fops, irqp);
# ifdef CONFIG_GENERIC_IRQ_EFFECTIVE_AFF_MASK
	proc_create_data("effective_affinity", 0666, desc->dir,
			 &irq_effective_aff_proc_fops, irqp);
	proc_create_data("effective_affinity_list", 0666, desc->dir,
			 &irq_effective_aff_list_proc_fops, irqp);
# endif
#endif
	proc_create_data("spurious", 0666, desc->dir,
...
{
#ifdef CONFIG_SMP
	proc_create("irq/default_smp_affinity", 0666, NULL,
