...
static struct drm_conn_prop_enum_list drm_connector_enum_list[] = {
	...
	{ DRM_MODE_CONNECTOR_DPI, "DPI" },//17
	{ DRM_MODE_CONNECTOR_RESERVED1, "Reserved1" },//18
	{ DRM_MODE_CONNECTOR_RESERVED2, "Reserved2" },//19
	{ DRM_MODE_CONNECTOR_CAST_AP, "CAST_AP"},//20
	{ DRM_MODE_CONNECTOR_CAST_SIDE, "CAST_SIDE"},//21
};
		       ...
		       int connector_type)
{
	...
	if(connector_type > (ARRAY_SIZE(drm_connector_enum_list) - 1)) {
		DRM_WARN("Connector-mode is not supported in drm_connector_enum_list, \
			set Connector-mode : DRM_MODE_CONNECTOR_Unknown\n");
		connector_type = DRM_MODE_CONNECTOR_Unknown;
	}

	connector_ida = &drm_connector_enum_list[connector_type].ida;
