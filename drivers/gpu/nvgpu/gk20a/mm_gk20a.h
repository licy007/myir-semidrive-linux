...
int gk20a_gmmu_alloc_map(struct vm_gk20a *vm, size_t size,
		struct mem_desc *mem);
int gk20a_gmmu_alloc_map_attr(struct vm_gk20a *vm, unsigned long attr,
		size_t size, struct mem_desc *mem);

int gk20a_gmmu_alloc_map_sys(struct vm_gk20a *vm, size_t size,
		struct mem_desc *mem);
int gk20a_gmmu_alloc_map_attr_sys(struct vm_gk20a *vm, unsigned long attr,
		size_t size, struct mem_desc *mem);

int gk20a_gmmu_alloc_map_vid(struct vm_gk20a *vm, size_t size,
		struct mem_desc *mem);
int gk20a_gmmu_alloc_map_attr_vid(struct vm_gk20a *vm, unsigned long attr,
		size_t size, struct mem_desc *mem);
...
int gk20a_gmmu_alloc_attr_sys(struct gk20a *g, unsigned long attr, size_t size,
		struct mem_desc *mem);

int gk20a_gmmu_alloc_vid(struct gk20a *g, size_t size, struct mem_desc *mem);
int gk20a_gmmu_alloc_attr_vid(struct gk20a *g, unsigned long attr, size_t size,
		struct mem_desc *mem);
