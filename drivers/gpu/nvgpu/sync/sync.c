...
static inline bool
fence_is_signaled_locked_ts(struct dma_fence *fence, u64 timestamp)
{
...
struct sync_fence *sync_fence_create(const char *name, struct sync_pt *pt)
{
	...
	if (dma_fence_add_callback(&pt->base, &fence->cbs[0].cb,
			       fence_check_cb_func))
...
struct sync_pt *sync_pt_from_fence(struct dma_fence *fence)
{
