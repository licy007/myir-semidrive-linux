...
#define FENCE_ERR   DMA_FENCE_ERR
#define FENCE_TRACE DMA_FENCE_TRACE
#define FENCE_WARN  DMA_FENCE_WARN
...
extern struct sync_pt *sync_pt_from_fence(struct dma_fence *fence);
...
#if 0//def CONFIG_DEBUG_FS  // remove debugfs entry
...
# define sync_dump()
#endif
int sync_fence_wake_up_wq(wait_queue_entry_t *curr, unsigned mode,
