...
#define DM_GET_BLK_DEV_INTERVAL_MS 1
#define DM_GET_BLK_DEV_TIMEOUT_MS 5000
			     ...
			     struct mapped_device *md)
{
	...
	int loopcnt = DM_GET_BLK_DEV_TIMEOUT_MS / DM_GET_BLK_DEV_INTERVAL_MS;
	int r;
...
retry:
	...
	if (devnotfound && loopcnt) {
		msleep(DM_GET_BLK_DEV_INTERVAL_MS);
		devnotfound = false;
		loopcnt--;
		goto retry;
	}
