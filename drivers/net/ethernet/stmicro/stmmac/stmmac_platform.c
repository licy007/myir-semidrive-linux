...
stmmac_probe_config_dt(struct platform_device *pdev, const char **mac)
{
	...
	*mac = of_get_mac_address(np);
	...
	/* by semidrive*/
	of_property_read_u32(np, "semidrive,multicast_filter_bins", &plat->multicast_filter_regs);
	of_property_read_u32(np, "semidrive,mcast_bits_log2", &plat->mcast_bits_log2);
