...
# define cryptodev_crypto_alloc_blkcipher crypto_alloc_blkcipher
...
# define cryptodev_crypto_blkcipher_reqtfm crypto_ablkcipher_reqtfm
#else
...
# define cryptodev_crypto_blkcipher_reqtfm crypto_skcipher_reqtfm
#endif
